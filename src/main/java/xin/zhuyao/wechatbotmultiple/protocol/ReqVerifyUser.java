...
public class ReqVerifyUser {
    ...
    public ReqVerifyUser(xin.zhuyao.wechatbotmultiple.protocol.BaseRequest baseRequest, int opCode, String userName, String verifyTicket, String verifyContent) {
