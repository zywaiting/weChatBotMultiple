...
import xin.zhuyao.wechatbotmultiple.entity.message.*;
import xin.zhuyao.wechatbotmultiple.protocol.*;
import xin.zhuyao.wechatbotmultiple.utils.QRCodeUtils;
        ...
        private String login() {
            try {
                if (XTools.strEmpty(wxAPI.sid)) {
                    ...
                    download(qrCode, "weChat.jpg", directory.getCanonicalPath());
                    while (true) {
